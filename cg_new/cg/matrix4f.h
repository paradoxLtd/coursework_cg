...
public:
    ...
    Matrix4f InitPerspective(double fov, double aspectRatio, double zNear, double zFar);
    Matrix4f InitOrthographic(double left, double right, double bottom, double top, double near, double far);
